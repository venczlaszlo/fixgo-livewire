            ...
            <div class="flex flex-col sm:flex-row items-center sm:items-start space-x-6">
                ...
                @if($service->image)
                    <div class="flex-shrink-0 hidden lg:block">
                        <img src="{{ $service->image ? asset('images/' . $service->image) : asset('images/default-image.jpg') }}" alt="{{ $service->name }}" class="w-[300px] h-[200px] object-cover rounded-lg shadow-lg">
                    </div>
                @endif
            </div>
