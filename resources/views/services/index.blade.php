<x-main-layout>
    <div class="container mx-auto px-4 py-8 text-black">
        <h1 class="text-4xl font-bold text-left text-black dark:text-white mb-8 mt-25">Szolgáltatások</h1>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white/80 dark:bg-gray-800 shadow-lg rounded-lg p-6 text-black dark:text-white transition-transform transform hover:scale-105 hover:bg-gray-100 dark:hover:bg-gray-700 duration-300 ease-in-out">
                <div class="flex items-center space-x-4 mb-4">
                    ...
                    <a href="{{ url('/services/' . $service->slug) }}" class="mt-4 inline-block bg-blue-600 text-white px-6 py-3 rounded-full hover:bg-blue-700 transition-colors duration-300">
                        Részletek
                    </a>
                </div>
            @endforeach
